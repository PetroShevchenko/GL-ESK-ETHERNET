...
int main(void)
{
  ...
  /* definition and creation of udpServer */
  osThreadDef(udpServer, StartUdpServerTask, osPriorityNormal, 0, 2048);
  udpServerHandle = osThreadCreate(osThread(udpServer), NULL);
